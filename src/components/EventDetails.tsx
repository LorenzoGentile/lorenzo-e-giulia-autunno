    ...
    <div id="dettagli" className="section-container bg-opacity-20 bg-transparent">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-center sm:divide-x-2 sm:divide-autumn-gold my-6 space-y- sm:space-y-0">
          <div className="sm:px-8 text-center">
            ...
            <div className="flex items-center justify-center">
              ...
              <span className="text-lg sm:text-xl">12:00</span>
            </div>
          </div>
          <div className="sm:px-8 text-center">
            <h4 className="text-xl sm:text-2xl font-playfair text-autumn-burgundy mb-2">Il Ricevimento</h4>
            <div className="flex items-center justify-center">
              <Clock className="w-5 h-5 text-autumn-terracotta mr-2" />
              <span className="text-lg sm:text-xl">14:00</span>
            </div>
          </div>
        </div>
      ...
      <div className="mt-12 text-center">
        ...
        <div className="aspect-w-16 aspect-h-9 mt-6">
          <iframe title="Wedding Location Map" className="w-full rounded-lg shadow-md" style={{ height: '32rem' }} src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2976.850274525637!2d12.689743476273291!3d41.745322273716674!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1325842cc3471461%3A0x65f6ee5e5210a1f5!2sVilla%20del%20Cardinale!5e0!3m2!1sen!2sit!4v1749109190719!5m2!1sen!2sit" loading="lazy"></iframe>
        </div>
      </div>
    </div>
  );
